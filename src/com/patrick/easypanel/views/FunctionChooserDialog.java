...
public class FunctionChooserDialog extends AlertDialog {
    ...
    public FunctionChooserDialog(Context context) {
        ...
        layout.addView(progressBar,ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
        this.setView(layout);
    ...
    public void notifyLoaded(ArrayList<FunctionItem> items)
    {
        ...
        layout.addView(listView,ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                if (listener !=null){
                    listener.onChoose(FunctionChooserDialog.this, m_items.get(i));
                }
            }
        });
    ...
    class FunctionItemAdapter extends BaseAdapter{
        ...
        public View getView(int i, View convertView, ViewGroup parent) {
            ...
            if (convertView == null)
            {
                ...
                convertView = inflater.inflate(R.layout.function_item, parent, false);
                holder.description = (TextView) convertView.findViewById(R.id.tvDescription);
                holder.head = (ImageView) convertView.findViewById(R.id.imgHead);
